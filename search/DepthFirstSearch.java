...
public class DepthFirstSearch<T> {
	 ...
	 * 
	 * @param vertex
	 *            The starting vertex to search from
	 */
	...
	/**
	 * Uses the recursive DFS algorithm to find a path between any two nodes in
	 * a graph. If no path exists, an empty string is printed.
	 * 
	 * @param current
